...
from keras.layers import Input, Dense, Dropout, Conv1D, Activation, Add, LeakyReLU
from keras.layers import GlobalAveragePooling1D, MaxPool1D, Concatenate, BatchNormalization
...
# Create 1D conv net based architecture with residual layers ################################
input_ = Input((sampleWindow, nSensors))

conv1 = Conv1D(64, 2, strides=1, padding='same')(input_)
conv1 = LeakyReLU()(conv1)
conv1 = Conv1D(64, 2, strides=1, padding='same')(conv1)
conv1 = LeakyReLU()(conv1)
pool = MaxPool1D()(conv1)

conv2 = Conv1D(64, 2, strides=1, padding='same')(pool)
conv2 = LeakyReLU()(conv2)
conv2 = Conv1D(64, 2, strides=1, padding='same')(conv2)
conv2 = LeakyReLU()(conv2)
conv2 = Add()([conv2, pool])
conv2 = BatchNormalization()(conv2)

conv3 = Conv1D(64, 2, strides=1, padding='same')(conv2)
conv3 = LeakyReLU()(conv3)
conv3 = Conv1D(64, 2, strides=1, padding='same')(conv3)
conv3 = LeakyReLU()(conv3)
conv3 = Add()([conv3, conv2])
conv3 = BatchNormalization()(conv3)

conv4 = Conv1D(64, 2, strides=1, padding='same')(conv3)
conv4 = LeakyReLU()(conv4)
conv4 = Conv1D(64, 2, strides=1, padding='same')(conv4)
conv4 = LeakyReLU()(conv4)
conv4 = Add()([conv4, conv3])
conv4 = BatchNormalization()(conv4)

conv5 = Conv1D(128, 5, strides=1, padding='same')(conv4)
conv5 = LeakyReLU()(conv5)
conv5 = Conv1D(128, 5, strides=1, padding='same')(conv5)
conv5 = LeakyReLU()(conv5)
globalpool = GlobalAveragePooling1D()(conv5)

dense1 = Dense(800, activation='relu')(globalpool)
